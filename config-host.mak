...
# Configured with: './configure' '--prefix=/home/ub/development/'
CONFIG_QEMU_SHAREDIR="/home/ub/development//share/qemu"
ARCH=i386
STRIP_OPT=-s
HOST_LONG_BITS=32
CONFIG_POSIX=y
...
VERSION=0.12.50
PKGVERSION=
SRC_PATH=/home/ub/development/qemu-2010
...
LD=ld
CFLAGS=-O2 -g 
QEMU_CFLAGS=-I$(SRC_PATH)/slirp -Werror -m32 -Wold-style-definition -Wold-style-declaration -I. -I$(SRC_PATH) -U_FORTIFY_SOURCE -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wendif-labels -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing 
